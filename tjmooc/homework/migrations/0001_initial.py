    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('judge_user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='homework_judge_user_id', to='user.User')),
                ('submit_user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='homework_submit_user_id', to='user.User')),
            ],
        ),
        migrations.CreateModel(
            name='Test',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(null=True)),
                ('submit_user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_submit_user_id', to='user.User')),
